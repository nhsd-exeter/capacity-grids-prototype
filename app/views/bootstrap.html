  ...
  <div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="active"><a href="index.html">CSS</a></li>
  ...
  <main role="main" class="container">
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="rules">Rules</h1>
          </div>
        </div>
      </div>
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="colors">Colors</h1>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-lg-7 text-center text-white">
...
<div class="bg-danger-light"></div>
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="grid">Grid</h1>
          </div>
        </div>
      </div>
...
<div class="row">
  ...
  <div class="col-xs-6">
    <div class="row">
      <div class="col-xs-12 col-md6"></div>
      <div class="col-xs-12 col-md6"></div>
    </div>
  </div>
  ...
  <div class="col-xs-3"></div>
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="typography">Typography</h1>
          </div>
        </div>
      </div>
...
<p class="text-uppercase">Uppercased text.</p>
<p class="text-capitalize">Capitalized text.</p>
<h2>Bigger text with <span class="text-uppercase">uppercase text</span></h2>
<h2>Bigger text with <span class="text-uppercase">uppercase text</span></h2>
          </div>
        </div>
        <div class="col-xs-12 col-lg-5">
  ...
  <dd>Description for term 2</dd>
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="tables">Tables</h1>
          </div>
        </div>
      </div>
  ...
  <tbody>
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="forms">Forms</h1>
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="buttons">Buttons</h1>
          </div>
        </div>
      </div>
...
<h1 class="btn btn-warning">Warning </h1>
  ...
  <a href="#" class="btn btn-default">Button</a>
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="images">Images</h1>
          </div>
        </div>
      </div>
...
<img src="https://placeimg.com/102/102/any" alt="..." class="img-thumbnail">
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="position">Position</h1>
          </div>
        </div>
      </div>
  ...
  <div class="col-xs-12">
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="show-and-hide">Show and Hide elements</h1>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-lg-7">
          ...
          <div class="code-example">
<div class="show">Visible with <code>.show</code> </div>
<div class="hidden">Invisible with <code>.hidden</code> </div>
<span class="invisible">Invisible with <code>.invisible</code></span> « Something invisible here! </div>
        </div>
        <div class="col-xs-12 col-lg-5">
          <h4 class="doc-info-title">How to use</h4>
...
<a class="sr-only sr-only-focusable" href="#content">Skip to main content</a>
        ...
        <div class="col-xs-12 col-lg-7">
          ...
          <div class="code-example">
Phrase » <span class="text-hide">Custom heading</span> « with some text hidden
          </div>
        </div>
        <div class="col-xs-12 col-lg-5">
          <h4 class="doc-info-title">How to use</h4>
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="responsive">Responsive and Print classes</h1>
          </div>
        </div>
      </div>
...
<p class="visible-print-block">Visible as block for print  only</p>
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="dropdown">Dropdowns</h1>
          </div>
        </div>
      </div>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="tabs">Navigation</h1>
          </div>
        </div>
      </div>
    ...
    <article>
      ...
      <div class="row">
        <div class="col-xs-12 col-lg-7">
          ...
          <div class="code-example">
<!-- pagination-lg / pagination-sm / pagination-plain -->
<ul class="pagination">
  <li class="disabled"><a href="#">«</a></li>
  <li class="active"><a href="#">1</a></li>
  <li><a href="#">2</a></li>
  ...
  <li class="next"><a href="#">Newer →</a></li>
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="indicators">Indicators</h1>
          </div>
        </div>
      </div>
  ...
  <li><a href="#">Messages <span class="badge">3</span></a></li>
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="jumbotron">Jumbotron</h1>
          </div>
        </div>
      </div>
  ...
  <p><a class="btn btn-primary btn-lg" href="#" role="button">Learn more</a>
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="page-header">Page header</h1>
          </div>
        </div>
      </div>
  ...
  <h1>Example page header <small>Subtext for header</small></h1>
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="page-header">Custom elements</h1>
          </div>
        </div>
      </div>
  ...
  <div class="col-xs-12 col-sm-6">
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="alerts">Alerts</h1>
          </div>
        </div>
      </div>
  ...
  <strong>Heads up!</strong> This <a href="#" class="alert-link">alert needs your attention</a>, but it's not super important.
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="progress-bars">Progress bars</h1>
          </div>
        </div>
      </div>
  ...
  <div class="progress-bar progress-bar-danger" style="width: 80%"></div>
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="media-object">Media object</h1>
          </div>
        </div>
      </div>
  ...
  <div class="media-body">
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="containers">Containers</h1>
          </div>
        </div>
      </div>
  ...
  <a href="#" class="list-group-item">
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="Panels">Panels</h1>
          </div>
        </div>
      </div>
  ...
  <div class="panel-body">
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="wells">Wells</h1>
          </div>
        </div>
      </div>
  ...
  Look, I'm in a large well!
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="dialogs">Dialogs</h1>
          </div>
        </div>
      </div>
...
<button type="button" class="btn btn-default" data-container="body" data-toggle="popover" data-placement="left" data-title="Title popover" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-original-title="" title="">Left</button>
<button type="button" class="btn btn-default" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-original-title="" title="">Top</button>
<button type="button" class="btn btn-default" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-original-title="" title="">Bottom</button>
<button type="button" class="btn btn-default" data-container="body" data-toggle="popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-original-title="" title="">Right</button>
          </div>
        </div>
        <div class="col-xs-12 col-lg-5">
...
<button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="left" title="" data-original-title="Tooltip on left">Left</button>
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="collapse">Collapse</h1>
          </div>
        </div>
      </div>
  ...
  <div class="panel panel-default">
    ...
    <article>
      <div class="row">
        <div class="col-xs-12">
          <div class="page-header">
            <h1 class="doc-section-title" id="carousel">Carousel</h1>
          </div>
        </div>
      </div>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <style>
    ...
    #nav_doc {
      ...
      padding-left: 15px;
      box-shadow: -10px 0px 20px 0px rgba(158, 158, 158, 0.2);
    }
    ...
    .container pre.language-markup{
      position: relative;
      box-shadow: 0 0 0px 8px #272822;
      border: 0;
      padding: 5px;
      margin: 0 0 15px 0;
    }
    ...
    pre.language-markup:hover .btn_copy{
      display: block;
